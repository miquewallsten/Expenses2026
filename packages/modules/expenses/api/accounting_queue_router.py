...
router = APIRouter(prefix="/accounting/queue", tags=["accounting"], dependencies=[Depends(require_module("accounting"))])
...
def get_accounting_queue(
    ...
    """Get paginated accounting review queue."""
