              ...
              <div
                ...
                className={`p-4 rounded border cursor-pointer transition-colors ${
                  selectedTeam === team.id
                    ? "bg-accent-muted bg-blue-400/10"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-3 text-xs">
                      <span className="text-tertiary">{team.requestCount} requests</span>
                      <span className="text-success">{team.successRate}% success</span>
                      <span className="text-tertiary">{team.avgLatency}ms avg</span>
                    </div>
                  </div>
        ...
        <div className="bg-surface-1 rounded-lg p-6">
          ...
          {selectedTeamData ? (
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-primary">{selectedTeamData.name}</h3>
                <p className="text-secondary text-sm">{selectedTeamData.description}</p>
              </div>
              ...
              {selectedPerformance && (
                <>
                  ...
                  <div>
                    <h4 className="font-medium text-primary mb-3">Tool Usage</h4>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-tertiary">Select an agent team to view details</p>
            </div>
          )}
        </div>
      </div>
