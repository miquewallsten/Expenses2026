...
export default function EmployeeUploadPage() {
  ...
  const summaryPill = (status: UploadItem["status"]) => {
    switch (status) {
      case "valid":     return "bg-emerald-500/20 text-emerald-300 border-emerald-500/40";
      ...
      case "validating":return "bg-sky-500/20 text-sky-300 border-sky-500/40";
    ...
    <main className="min-h-screen bg-neutral-950 text-white pb-28">
      <div className="mx-auto max-w-7xl px-6 py-10">
            ...
            <div className="flex items-start justify-between gap-6">
              <div>
                ...
                <div className="flex items-center gap-5">
                  <div>
                    <div className="text-[10px] font-bold uppercase tracking-widest text-white/35">{t("reportId")}</div>
                    <div className="text-sm font-mono text-white/70">#{submissionSuccess.report_id}</div>
                  </div>
                  <div className="w-px h-8 bg-white/10" />
                  <div>
                    <div className="text-[10px] font-bold uppercase tracking-widest text-white/35">{t("documentsLinked")}</div>
        ...
        <div className="mb-10 rounded-3xl border border-white/10 bg-gradient-to-r from-sky-500/10 via-indigo-500/10 to-emerald-500/10 p-8 shadow-2xl shadow-black/20 backdrop-blur">
          <div className="flex items-start justify-between gap-6">
            <div>
              <p className="mb-3 text-sm uppercase tracking-[0.25em] text-white/50">{t("portalLabel")}</p>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-right">
              <div className="text-xs text-white/50">{t("validFiles")}</div>
