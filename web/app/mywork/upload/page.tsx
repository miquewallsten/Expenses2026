                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    {!file.validationResults.length ? (
                      <div className="rounded-2xl border border-subtle bg-surface-1 px-4 py-3 text-sm text-secondary">
                        {emptyValidationMessage(file)}
                      </div>
                    ) : (
                      <div className="space-y-2">
                        {file.validationResults.map((result, index) => (
                          <div key={`${file.localId}-${index}`} className="rounded-2xl border border-subtle bg-surface-1 p-3">
